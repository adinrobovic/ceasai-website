...
export default function Home() {
  return (
    <PageTransition>
      {/* Hero Section */}
      <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-black via-[#0A0F1C] to-black text-white px-6 pt-28 md:pt-0">
